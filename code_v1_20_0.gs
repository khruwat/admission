// v1_20_0: เขตพื้นที่บริการแบบที่อยู่โรงเรียนเดิม (SERVICE_AREA_ZONES)
/* =============================================================
   ระบบรับสมัครนักเรียน โรงเรียนหนองนาคำวิทยาคม
   Student Enrollment System  v1.20.0
   ─────────────────────────────────────────────────────────────
...
const SETTINGS_DEFAULTS = [
  ...
  ['CHANGELOG_TEXT',     'v1.20.0 – 2569-03-18 – เขตพื้นที่บริการแบบที่อยู่โรงเรียนเดิม\nv1.19.2 – 2569-03-17 – Fix: uploadLogo\nv1.19.1 – 2569-03-17 – Bugfix addAdminUser + exportScoreSheetUrl\nv1.19.0 – 2569-03-17 – ระบบคะแนนสอบ + Export Google Sheet'],
  ['ANNOUNCEMENT',       ''],
  ['ANNOUNCE_IMAGE',     ''],
  ['ANNOUNCE_POPUP',     'true'],
