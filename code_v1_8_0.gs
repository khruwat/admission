/* =============================================================
   ...
   ─────────────────────────────────────────────────────────────
   CHANGELOG
   v1.8.0 – 2569-03-17 – ระบบบันทึกที่อยู่ขั้นสูง
              เพิ่ม columns: HOUSE_NO, BUILDING, MOO, SOI, ROAD
              เพิ่ม columns ที่อยู่ติดต่อ: CUR_SAME_AS_HOME,
                CUR_HOUSE_NO, CUR_BUILDING, CUR_MOO, CUR_SOI,
                CUR_ROAD, CUR_SUBDISTRICT, CUR_DISTRICT,
                CUR_PROVINCE, CUR_ZIP
              _migrateAppSheet() เพิ่ม column ใหม่อัตโนมัติ
              getGeoData() ยังคงไว้ (backward compat / fallback)
