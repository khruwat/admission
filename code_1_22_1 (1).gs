// v1_22_1: โหมดทดสอบระบบ (TEST_MODE) — ข้าม checksum + วันเปิด/ปิดรับสมัคร
/* =============================================================
   ระบบรับสมัครนักเรียน โรงเรียนหนองนาคำวิทยาคม
   Student Enrollment System  v1.22.1
   ─────────────────────────────────────────────────────────────
...
function submitApplication(data) {
  ...
  const cfg      = getSettings();
  const testMode = String(cfg.TEST_MODE || 'false') === 'true';

  // ตรวจ checksum บัตรประชาชน — ข้ามเมื่อ TEST_MODE=true
