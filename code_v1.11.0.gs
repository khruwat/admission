/* =============================================================
   ...
   Student Enrollment System  v1.11.0
   ─────────────────────────────────────────────────────────────
...
const SETTINGS_DEFAULTS = [
  ...
  ['DEVELOPER_POSITION', ''],
  ['DEVELOPER_PHONE',    ''],
  ['SYSTEM_VERSION',     'v1.11.0'],
  ['CHANGELOG_TEXT',     'v1.11.0 – 2569-03-17 – ขยายสิทธิ์แก้ไข, lock "รายงานตัวแล้ว", ขยาย ALLOWED_FIELDS\nv1.10.0 – 2569-03-17 – แก้บั๊ก timezone วันเดือนปีเกิด (critical fix)\nv1.9.0 – 2569-03-17 – ยืนยันตัวตนด้วยวันเกิดก่อนแก้ไขใบสมัคร'],
  ['ANNOUNCEMENT',       ''],
