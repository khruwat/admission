/* =============================================================
   ...
   Student Enrollment System  v1.15.0
   ─────────────────────────────────────────────────────────────
...
const SETTINGS_DEFAULTS = [
  ...
  ['DEVELOPER_POSITION', ''],
  ['DEVELOPER_PHONE',    ''],
  ['SYSTEM_VERSION',     'v1.15.0'],
  ['CHANGELOG_TEXT',     'v1.15.0 – 2569-03-17 – Dashboard filter + ตารางรายวัน + Export CSV\nv1.14.0 – 2569-03-17 – ระบุเพศอัตโนมัติจากคำนำหน้าชื่อ (GENDER)\nv1.13.0 – 2569-03-17 – แผนการเรียนรายชั้น M1–M6 (per-grade study plans)'],
  ['ANNOUNCEMENT',       ''],
