/* =============================================================
   ...
   Student Enrollment System  v1.16.0
   ─────────────────────────────────────────────────────────────
   ...
   v1.16.0 – 2569-03-17 – Announcement popup + Export PDF
              SETTINGS_DEFAULTS: ANNOUNCE_IMAGE (URL รูป), ANNOUNCE_POPUP (true/false)
              popup แสดงครั้งแรกต่อ session (sessionStorage)
              รองรับ text / รูปภาพ / ทั้งคู่
              Export PDF ตารางรายวัน (print-to-PDF อัตโนมัติ)
...
const SETTINGS_DEFAULTS = [
  ...
  ['DEVELOPER_POSITION', ''],
  ['DEVELOPER_PHONE',    ''],
  ['SYSTEM_VERSION',     'v1.16.0'],
  ['CHANGELOG_TEXT',     'v1.16.0 – 2569-03-17 – Announcement popup + Export PDF\nv1.15.0 – 2569-03-17 – Dashboard filter + ตารางรายวัน + Export CSV\nv1.14.0 – 2569-03-17 – ระบุเพศอัตโนมัติจากคำนำหน้าชื่อ (GENDER)'],
  ['ANNOUNCEMENT',       ''],
  ['ANNOUNCE_IMAGE',     ''],
  ['ANNOUNCE_POPUP',     'true'],
...
function getStats(token) {
  ...
  // ─── Daily Detailed Trend 30 วัน ───
  // แต่ละวัน: { m1:{ชาย,หญิง,ในเขต,นอกเขต,รวม}, m4:{ชาย,หญิง,ม3เดิม,ม3อื่น,รวม}, total }
