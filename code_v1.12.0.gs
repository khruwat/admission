/* =============================================================
   ...
   Student Enrollment System  v1.12.0
   ─────────────────────────────────────────────────────────────
...
const SETTINGS_DEFAULTS = [
  ...
  ['DEVELOPER_POSITION', ''],
  ['DEVELOPER_PHONE',    ''],
  ['SYSTEM_VERSION',     'v1.12.0'],
  ['CHANGELOG_TEXT',     'v1.12.0 – 2569-03-17 – เพิ่มรหัสประจำบ้าน + ที่อยู่ปัจจุบัน (HOUSE_CODE, CURR_*)\nv1.11.0 – 2569-03-17 – ขยายสิทธิ์แก้ไข, lock "รายงานตัวแล้ว", ขยาย ALLOWED_FIELDS\nv1.10.0 – 2569-03-17 – แก้บั๊ก timezone วันเดือนปีเกิด (critical fix)'],
  ['ANNOUNCEMENT',       ''],
